...
class FiltersSpec extends ObjectBehavior
{
    ...
    public function it_should_create_an_and_filter()
    {
    ...
    public function it_should_create_an_or_filter()
    {
