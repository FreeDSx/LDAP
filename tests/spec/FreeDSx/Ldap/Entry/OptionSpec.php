...
class OptionSpec extends ObjectBehavior
{
    ...
    public function it_should_detect_if_it_is_not_a_language_option()
    {
        $this->isLanguageTag()->shouldBeEqualTo(false);
    }
    
    public function it_should_detect_if_it_is_a_language_option()
    {
    ...
    public function it_should_detect_if_it_is_not_a_range_option()
    {
        $this->isRange()->shouldBeEqualTo(false);
    }

    public function it_should_detect_if_it_is_a_range_option()
    {
    ...
    public function it_should_get_the_high_range_value_of_an_option()
    {
        $this->beConstructedWith('range=0-1500');
    ...
    public function it_should_return_an_empty_string_if_the_high_range_cannot_be_parsed()
    {
        $this->getHighRange()->shouldBeEqualTo('');
    }
    
    public function it_should_get_the_low_range_value_of_an_option()
    {
        $this->beConstructedWith('range=0-1500');
    ...
    public function it_should_return_null_if_the_low_range_cannot_be_parsed()
    {
        $this->getLowRange()->shouldBeNull();
    }
    
    public function it_should_have_a_factory_method_for_a_range()
    {
    ...
    public function it_should_return_whether_the_option_starts_with_a_string()
    {
        $this->startsWith('fo')->shouldBeEqualTo(true);
        $this->startsWith('bar')->shouldBeEqualTo(false);
    }
    
    public function it_should_get_the_string_option_with_toString()
    {
    ...
    public function it_should_check_for_equality_with_another_option()
    {
